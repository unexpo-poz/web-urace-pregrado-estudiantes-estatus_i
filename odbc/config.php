...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/estudiantes/estatus_i/';
...
//$LBT	= 'consulta_calificaciones_2010-1I.log'; //
$LBT	= $_SERVER[DOCUMENT_ROOT].'/log/pregrado/estudiantes/consulta_estatus_'.$lapsoProceso.'.log';
...
if ($modoInscripcion == '1'){
	$tProceso	= 'Consulta de Estatus Individual Intensivo ';
}
